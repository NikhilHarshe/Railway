...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const [masterEidt, setmasterEdit] = useState(false);
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-[20px]">
              ...
              {user?.Role === 'SuperAdmin' && (
                <li onMouseEnter={() => handleDropDown()} onMouseLeave={()=>handleRemoveDropDown()} >
                  <NavLink
                    // to="/master"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-graydark dark:text-bodydark1 duration-300 ease-in-out hover:bg-[#F1F5F9] dark:hover:bg-meta-4 ${
              ...
              )}
              {
                ...
                <div>
                    <li>Update Agency</li>
                    <li>Update Contract type</li>
                    <li>Update Train List</li>
                    <li>Update Section Names</li>
                    <li>Update Station Names</li>
                </div>
              }
              {/* Admin */}
              {user?.Role === 'SuperAdmin' && (
