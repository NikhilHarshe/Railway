            ...
            <form onSubmit={handleSubmit} style={{}} action="#">
              <div className="p-6.5">
                ...
                <div className=' flex flex-col pb-5 gap-2'>
                  <label htmlFor="aadharCardImg" className="mb-2.5 block text-black dark:text-white">Uploade Aadhar Card <span className=' text-red-600 text-lg'>*</span></label>
                ...
                <div className=' flex flex-col pb-5 gap-2'>
                  <label htmlFor="policeVarificationDocument" className="mb-2.5 block text-black dark:text-white">Upload PoliceVarification Document <span className=' text-red-600 text-lg'>*</span></label>
                  <input type="file" name='policeVarificationDocument' onChange={handleChange} />
                </div>

                {/* Upload MadicalValidity Document */}
                <div className=' flex flex-col pb-5 gap-2'>
                  <label htmlFor="madicalValidityDocument" className="mb-2.5 block text-black dark:text-white">Upload MadicalValidity Document <span className=' text-red-600 text-lg'>*</span></label>
                ...
                {/* Upload Profile Pic */}
                <div className=' flex flex-col pb-5 gap-2'>
                  <label htmlFor="profilePic" className="mb-2.5 block text-black dark:text-white">Upload Profile Photo <span className=' text-red-600 text-lg'>*</span></label>
